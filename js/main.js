...
(function () {
  ...
  var KF = {
    /* darkness over the scene (1 = pure black). The lines bring haze with them (see `light`), then the whole scene lifts to its colour. */
    dark:     [[0, 1], [.5, .985], [1.0, .93], [1.6, .60], [2.2, .24], [2.8, .16], [L0 + .8, .18], [L0 + 1.8, .30], [F, .20], [F + .4, .10], [F + 1.1, 0]],
    light:    [[0, .35], [1.2, .5], [2.4, .5], [3.0, 0]],   // strength of the haze that the entering lines leave behind
    reach:    [[0, .10], [.9, .18], [2.4, 1]],              // how far the light has reached (drives the colour of the lines)
    heat:     [[.3, 0], [1.6, .3], [2.8, .5], [F - 1, .55], [F, .6], [F + 1.1, 1]],   // coral-red → pink → (finally) the original white
    atmos:    [[0, 0], [.8, 0], [1.4, .10], [2.4, .12], [L0, .06], [F, .03], [F + .5, 0]],
    vignette: [[0, 0], [.6, 0], [1.4, .24], [2.8, .14], [F + .5, .10], [F + 1.1, 0]],
    wisp:     [[0, 0], [.8, .03], [2.0, .4], [3.0, .9], [L0 + 1.6, .5], [F, .55], [F + .9, 0]],
    titleGlow:[[.6, 0], [1.6, .20], [2.5, .22], [3.1, .08], [F + .4, .05], [F + 1.1, 0]],
    trailS:   [[0, 0], [.15, .95], [1.4, .9], [2.0, .12], [2.4, 0]],       // opening swirl fades away for the logo reveal
    trailL:   [[L0 - .2, 0], [L0 + .6, 1], [F, 1], [F + .5, 0]],           // strands converging on the node while loading
    dust:     [[0, 0], [.7, 0], [1.4, .7], [2.8, .85], [F, .55], [F + .4, 0]],
    micro:    [[0, 0], [.8, 0], [1.5, .45], [2.8, .7], [F, .8], [F + 1.1, .5]],
    glitter:  [[.5, 0], [1.2, .6], [2.4, .8], [F + 1.1, .85]],
    star:     [[.5, 0], [1.0, .7], [2.8, 1], [L0, .8], [F + 1.1, .3]],
    dens:     [[0, 1], [F + .3, 1], [F + 1.2, .72]],
  ...
  /* starbursts of the opening appear as the lines reach them: [time, x, y, size, life] */
  var FLARES = [[.30, .63, .17, 118, 3.4], [.55, .57, .545, 84, 3.6], [.62, .30, .262, 46, 3.0], [.75, .81, .745, 104, 3.8], [.90, .17, .655, 40, 3.2], [1.5, .32, .25, 58, 3.4], [1.7, .77, .43, 52, 3.2], [1.9, .16, .72, 48, 3.4]], flareI = 0;
  ...
  function render(dt, rawDt) {
    ...
    P.leafA = reduced ? 0 : kf(T, KF.leaf); P.dens = kf(T, KF.dens); P.lightK = reduced ? 0 : kf(T, KF.light);
