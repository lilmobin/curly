...
window.CURLY_CONFIG = {
  ...
  ------------------------------------------------------------------------ */
  timing: {
    titleStart:      2.8,   // light begins to pass over the title
    titleSweepEnd:   4.0,   // title fully revealed
    dissStart:       4.9,   // title starts dissolving into particles
    dissEnd:         5.7,   // …and is gone
    panelIn:         5.3,   // glass loading panel starts to appear
    loadStart:       5.7    // loading bar / flower bloom begins
  },

  /* ---- PERFORMANCE / VISUALS ------------------------------------------- */
  maxDPR: 2,                      // cap for canvas resolution (lower = faster on phones)
  residualFlower: 0.4             // how visible the faint lily stays while the home screen settles (0 = vanishes, 0.4 = reference-like)
};
