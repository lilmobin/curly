...
window.CURLY_CONFIG = {
  ...
  ------------------------------------------------------------------------ */
  timing: {
    titleStart:      0.9,   // light begins to pass over the title
    titleSweepEnd:   2.1,   // title fully revealed
    dissStart:       2.5,   // title starts dissolving into particles
    dissEnd:         3.1,   // …and is gone
    panelIn:         2.6,   // glass loading panel starts to appear
    loadStart:       3.0    // loading bar / flower bloom begins
  },
